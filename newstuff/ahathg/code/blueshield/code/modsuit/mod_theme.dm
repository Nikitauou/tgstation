/datum/mod_theme/blueshield
	...
	variants = list(
		"praetorian" = list(
			MOD_ICON_OVERRIDE = 'newstuff/ahathg/code/blueshield/icons/praetorian.dmi',
			MOD_WORN_ICON_OVERRIDE = 'newstuff/ahathg/code/blueshield/icons/worn_praetorian.dmi',
