...
#define JOB_HEAD_OF_SECURITY "Командрир InteQ"
#define JOB_RESEARCH_DIRECTOR "Глава R&D"
...
//Security
#define JOB_WARDEN "Сержант InteQ"
#define JOB_DETECTIVE "Детектив"
#define JOB_SECURITY_OFFICER "Солдат InteQ"
#define JOB_SECURITY_OFFICER_MEDICAL "Солдат InteQ (Medical)"
#define JOB_SECURITY_OFFICER_ENGINEERING "Солдат InteQ (Engineering)"
#define JOB_SECURITY_OFFICER_SCIENCE "Солдат InteQ (Science)"
#define JOB_SECURITY_OFFICER_SUPPLY "Солдат InteQ (Cargo)"
//Engineering
#define JOB_STATION_ENGINEER "Инженер"
#define JOB_ATMOSPHERIC_TECHNICIAN "Атмосферный техник"
//Medical
#define JOB_CORONER "Коронер"
...
#define JOB_CARGO_GORILLA "Горилла"
